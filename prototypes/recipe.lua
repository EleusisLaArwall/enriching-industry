...
--			category = mods["space-age"] and "chemistry-or-cryogenics" or "chemistry",
			categories = mods["space-age"] and {"chemistry", "cryogenics"} or {"chemistry"},
--			order = "d[stone]-d[quartz]",
			...
			energy_required = 1.2,
			ingredients = {
				{type="item", name="sand", amount=ei_settings.ei_stone_wash_in_sand_amount},
				{type="fluid", name="water", amount=10}
			},
			results = {
				{type="item", name="ei-quartz", amount=1, extra_count_fraction=ei_settings.ei_stone_wash_bonus_direct},
				{type="fluid", name="ei-tailing-slurry", amount=10, ignored_by_productivity=1000},
				EnrichingIndustry.make_washing_byproduct("sand", ei_settings.ei_stone_wash_bonus_primprec, 1, ei_settings.ei_productivity_precursor),
				EnrichingIndustry.make_washing_byproduct("stone", ei_settings.ei_stone_wash_bonus_secoprec, 1, ei_settings.ei_productivity_precursor),
			},
...
--			category = mods["space-age"] and "chemistry-or-cryogenics" or "chemistry",
			...
			results = {
				{type="item", name="ei-enriched-iron-ore", amount=1, extra_count_fraction=ei_settings.ei_wash_bonus_direct},
				{type="fluid", name="ei-tailing-slurry", amount=10, ignored_by_productivity=1000},
				EnrichingIndustry.make_washing_byproduct("crushed-iron-ore", ei_settings.ei_wash_bonus_primprec, 1, ei_settings.ei_productivity_precursor),
				EnrichingIndustry.make_washing_byproduct("iron-ore", ei_settings.ei_wash_bonus_secoprec, 1, ei_settings.ei_productivity_precursor),
			},
...
--			category = mods["space-age"] and "chemistry-or-cryogenics" or "chemistry",
			...
			results = {
				{type="item", name="ei-enriched-copper-ore", amount=1, extra_count_fraction=ei_settings.ei_wash_bonus_direct},
				{type="fluid", name="ei-tailing-slurry", amount=10, ignored_by_productivity=1000},
				EnrichingIndustry.make_washing_byproduct("crushed-copper-ore", ei_settings.ei_wash_bonus_primprec, 1, ei_settings.ei_productivity_precursor),
				EnrichingIndustry.make_washing_byproduct("copper-ore", ei_settings.ei_wash_bonus_secoprec, 1, ei_settings.ei_productivity_precursor),
			},
...
--			category = mods["space-age"] and "chemistry-or-cryogenics" or "chemistry",
			...
			ingredients = {
				{type="item", name="crushed-iron-ore", amount=1},
				{type="fluid", name="water", amount=10},
				{type="fluid", name="sulfuric-acid", amount=ei_settings.ei_leach_sulfuric_acid}
			},
			results = {
				{type="fluid", name="ei-sulfuric-iron-solution", amount=ei_settings.ei_leach_bonus_direct + 10},
				EnrichingIndustry.make_washing_byproduct("crushed-iron-ore", ei_settings.ei_leach_bonus_primprec, 1, ei_settings.ei_productivity_precursor),
			},
...
--			category = mods["space-age"] and "chemistry-or-cryogenics" or "chemistry",
			...
			results = {
				{type="fluid", name="ei-sulfuric-copper-solution", amount=ei_settings.ei_leach_bonus_direct + 10},
				EnrichingIndustry.make_washing_byproduct("crushed-copper-ore", ei_settings.ei_leach_bonus_primprec, 1, ei_settings.ei_productivity_precursor),
			},
...
--			category = mods["space-age"] and "chemistry-or-cryogenics" or "chemistry",
			...
			results = {
				{type="item", name="ei-enriched-iron-ore", amount=1, extra_count_fraction=ei_settings.ei_recry_bonus_direct},
...
--			category = mods["space-age"] and "chemistry-or-cryogenics" or "chemistry",
			...
			results = {
				{type="item", name="ei-enriched-copper-ore", amount=1, extra_count_fraction=ei_settings.ei_recry_bonus_direct},
...
--			category = mods["space-age"] and "chemistry-or-cryogenics" or "chemistry",
			...
			results = {
				...
				{type="item", name="ei-enriched-iron-ore", amount=1},
				{type="item", name="ei-enriched-copper-ore", amount=1},
			},
			main_product = "water",
			crafting_machine_tint =
			{
		...
		{
			{
				...
				energy_required = 1,
				ingredients = {
					{type="item", name="sand", amount=ei_settings.ei_concrete_from_tailing_in_sand_amount},
					{type="fluid", name="ei-tailing-slurry", amount=100}
				},
				results = {
...
--				category = "chemistry-or-cryogenics",
				...
				results = {
					...
					{type="fluid", name="ei-tailing-slurry", amount=10, ignored_by_productivity=1000},
					EnrichingIndustry.make_washing_byproduct("crushed-tungsten-ore", ei_settings.ei_wash_bonus_primprec, 1, ei_settings.ei_productivity_precursor),
					EnrichingIndustry.make_washing_byproduct("tungsten-ore", ei_settings.ei_wash_bonus_secoprec, 1, ei_settings.ei_productivity_precursor),
				},
...
--				category = "chemistry-or-cryogenics",
				...
				results = {
					...
					EnrichingIndustry.make_washing_byproduct("holmium-powder", ei_settings.ei_wash_bonus_primprec, 1, ei_settings.ei_productivity_precursor),
					EnrichingIndustry.make_washing_byproduct("holmium-ore", ei_settings.ei_wash_bonus_secoprec, 1, ei_settings.ei_productivity_precursor),
				},
